...
<div class="col-lg-11">
<h1 class="h3 mb-2 text-gray-800">Edit Collection</h1>
</div>
...
@endif
<form method="post" action="{{route('collections.update',$collections->id)}}" enctype="multipart/form-data">
@csrf
@method('PUT') 
	...
	<div class="col-lg-10">
		...
		<div class="tab-content">
			<div class="tab-pane fade show active" id="old">
				<img src="{{asset($collections->photo)}} " class="img-fluid w-25">
				<input type="hidden" name="oldphoto" value="{{$collections->photo}} ">
			</div>
