...
<div class="row shadow  mb-4 container-fluid">
	...
	<div class=" col-lg-1 ">            
		<a href="{{route('collections.create')}} "> <button type="button" class="btn btn-success active">AddNew</button></a>
	</div>
</div>
	...
	<div class="table-responsive">
		...
		<tbody>
				...
				<tr>
					...
					<td><a href="{{route('collections.edit',$row->id)}} " class="btn btn-warning">Edit</a>
						<form method="post" action="{{route('collections.destroy',$row->id)}} " onsubmit="return confirm('Are you sure?')" style="display: inline;">
							@csrf
							@method('DELETE')
