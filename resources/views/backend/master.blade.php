...
<head>
  ...
  <title>Perfect Photo Studio</title>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="bookings.html">Bookings</a>
            <a class="collapse-item" href="{{route('packages.index')}}">Packages</a>
            <a class="collapse-item" href="{{route('photographies.index')}}">Photographies</a>
            <a class="collapse-item" href="{{route('subphotographies.index')}}">Subphotographies</a>
            <a class="collapse-item" href="{{route('collections.index')}}">Collections</a>
            <a class="collapse-item" href="{{route('types.index')}}">Types</a>
            <a class="collapse-item" href="">Messages</a>
            <a class="collapse-item" href="{{route('weddingdresses.index')}}">Wedding Dresses</a>
          </div>
        </div>
      </li>
