...
<div class="row shadow  mb-4 container-fluid">
	...
	<div class=" col-lg-1 ">            
		<a href="{{route('types.create')}} "> <button type="button" class="btn btn-success active">AddNew</button></a>
	</div>
</div>
<div class="card-table ">
	...
	<tbody>
				...
				<tr>
					...
					<td><a href="{{route('types.edit',$row->id)}} " class="btn btn-warning">Edit</a>
